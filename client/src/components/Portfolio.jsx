...
const Portfolio = () => {
  ...
  const handleTitleClick = (weburl) => {
    ...
    const isExternal = weburl.startsWith('http://') || weburl.startsWith('https://');
    if (isExternal) {
              ...
              >
                <div className="relative p-8 bg-n-8 rounded-[2.4375rem] overflow-hidden xl:p-15">
                  ...
                  <div className="relative z-1">
                    ...
                    <h4
                      className="h4 mb-4 cursor-pointer hover:underline"
                      onClick={() => handleTitleClick(item.weburl)}
                    >
                      {item.title}
                    </h4>
